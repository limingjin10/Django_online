...
class CourseOrg(models.Model):
    ...
    category = models.CharField(max_length=20, choices=(('pxjg', '声乐教研室'), ('gr', '器乐教研室'), ('gx', '乐理教研室')),
                                default='', verbose_name='教研室')
    desc = models.TextField(verbose_name='院系介绍')
    tag = models.CharField(max_length=10, verbose_name=u'院系标签')
...
class Teacher(models.Model):
    org = models.ForeignKey(CourseOrg, verbose_name='所属院系')
